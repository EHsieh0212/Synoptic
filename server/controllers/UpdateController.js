...
class CartUpdateController {
    ...
    async index(req, res) {
        ...
        // the below code works for after migrating the whole product & stock info to Redis
        ...
        await this.redisClientService.hincrby(`cart:${cartId}`, `product:${productId}`, purchaseQuantity);
