...
router.get(
  '/',
  [checkSession],
  asyncHandler((req, res) => indexController.index(req, res)),
);
router.put(
  '/',
  [checkSession],
  asyncHandler((req, res) => updateController.index(req, res)),
);
router.put(
  '/modifier',
  [checkSession],
  asyncHandler((req, res) => updateController.updateCart(req, res)),
);
router.delete(
  '/clearCart',
  [checkSession],
  asyncHandler((req, res) => updateController.clearCart(req, res)),
);
