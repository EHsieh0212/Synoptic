...
router.post('/register', authenticator('register'), asyncHandler(async (req, res) => {
...
router.get('/fbRegisterSignin/callback', authenticator('fb'), signJwt, asyncHandler(async (req, res) => {
...
router.get('/profile', authenticator('jwt'), asyncHandler(async (req, res) => {
